...
export const blogs = [
  {
    ...
    image: blog1,
    description:
      "Find out the best cities where renting a car is affordable, convenient, and offers the best travel experience in 2025.",
  },
  {
    ...
    image: blog2,
    description:
      "A step-by-step guide to selecting the perfect rental car based on budget, trip type, and personal preferences.",
  },
  {
    ...
    image: blog3,
    description:
      "Explore the benefits of renting luxury cars versus economy options and decide which suits your journey best.",
  },
  {
    ...
    image: blog4,
    description:
      "Essential tips for first-time renters to avoid hidden fees, choose the right insurance, and get the best deals.",
  },
  {
    ...
    image: blog5,
    description:
      "Discover smart strategies to save money and get the best value when renting cars for longer durations.",
  },
  {
    ...
    image: blog6,
    description:
      "Understand the pros and cons of renting a self-drive car compared to hiring a chauffeur-driven service.",
  },
  {
    ...
    image: blog7,
    description:
      "Learn how to plan and book the right rental car to make your road trips safe, comfortable, and enjoyable.",
  },
  {
    ...
    image: blog8,
    description:
      "An expert overview of the latest car rental market trends, from electric vehicles to flexible rental models.",
  },
];
